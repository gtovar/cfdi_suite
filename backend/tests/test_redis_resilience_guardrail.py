...
ALLOWLIST: set[tuple[str, int]] = {
    ...
    (
        ...
        #
        # NOTA para quien mantenga esto: esta entrada se ha renumerado 3 veces
        # en dos días. Si vuelve a pasar seguido, vale más anclar el ALLOWLIST
