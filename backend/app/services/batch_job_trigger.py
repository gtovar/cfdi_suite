...
def trigger_batch_shard_job(batch_id: str, total_xmls: int, template_id: str) -> str:
    """
    ...
    Precondición: el manifiesto del batch (pdf:batch_ids:{batch_id} en Redis)
    y los XMLs (xml_temp/{job_id}.xml en GCS) ya deben existir completos —
    llamar esto solo después de que la extracción del ZIP haya terminado.
    """
