...
|---|---|---|
| [01 — Propiedad de rutas GCS](01-gcs-path-ownership.md) | Proceder | Sí |
...
No se edita `registro-unificado.md`: es un artefacto generado. La ejecución de
este cambio queda limitada al Plan 01; los demás documentos son decisiones de
trabajo pendientes, no declaración de implementación.
